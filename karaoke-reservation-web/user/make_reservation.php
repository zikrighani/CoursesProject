...
$packageQuery = "SELECT packageName, pricePerHour, description FROM packages ORDER BY pricePerHour";
...
<body>
          ...
          <div class="col-lg-8">
            ...
            <div class="form-section">
              ...
              <div class="room-grid">
                <?php 
                $roomImages = [
                  'Standard' => '../assets/images/standard-room.png',
                  'Deluxe' => '../assets/images/deluxe-room.png',
                  'VIP' => '../assets/images/vip-room.png'
                ];
                
                $roomFeatures = [
                  'Standard' => ['Basic sound system', '2 microphones', '40" TV screen', 'Perfect for 2-4 people'],
                  'Deluxe' => ['Enhanced sound system', '4 microphones', '50" TV screen', 'Great for 5-8 people'],
                  'VIP' => ['Premium sound system', '6 microphones', '65" TV screen', 'Luxury for 8-12 people']
                ];
                ...
                ?>
                  <div class="room-card" onclick="selectRoom('<?php echo $packageName; ?>')">
                    <div class="room-image" style="background-image: url('<?php echo $roomImages[$packageName]; ?>');"></div>
                    <div class="room-details">
                      <h4 class="room-title"><?php echo $packageName; ?> Room</h4>
                      <p class="room-description"><?php echo htmlspecialchars($package['description']); ?></p>
                      <ul class="room-features">
                        <?php foreach($roomFeatures[$packageName] as $feature): ?>
                          <li><?php echo $feature; ?></li>
                        <?php endforeach; ?>
                      </ul>
                      <div class="room-price">RM <?php echo number_format($package['pricePerHour'], 2); ?>/hour</div>
                      <div class="room-select-container">
                        <input class="form-check-input room-select" type="radio" name="room" id="<?php echo strtolower($packageName); ?>-room" value="<?php echo $packageName; ?>" required>
                        <label class="form-check-label" for="<?php echo strtolower($packageName); ?>-room">
                          Select Room
                        </label>
                      </div>
                    </div>
  ...
  <script>
    ...
    function selectRoom(roomType) {
        ...
        const selectedCard = document.getElementById(roomType.toLowerCase() + '-room').closest('.room-card');
